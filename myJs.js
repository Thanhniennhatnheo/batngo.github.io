const textConfig = {
  ...
  text5: "Có cái nịt nhé",
  text6: "Thích chứ",
  text7: "Gửi lí do cậu thích tớ đi :))",
  text8: "Send",
  text9: "Vì tớ thích cậu mất rồi",
  text10: "Tớ biết mà ^^ Làm ny mình nhé !",
  text11:
    "Vừa rồi chỉ là đùa thôi đừng mừng hụt nhé :))",
  text12: "Tiếp tục...",
};
...
$(document).ready(function () {
  ...
  function firstQuestion() {
    ...
    Swal.fire({
      ...
      imageUrl: "img/cho-con-tui-than-chi-hai-ngon-tay-vao-nhau.jpg",
      imageWidth: 300,
      imageHeight: 300,
